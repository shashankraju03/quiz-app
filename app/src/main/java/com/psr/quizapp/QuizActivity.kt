...
import com.psr.quizapp.models.Questions
import java.util.*
...
class QuizActivity : AppCompatActivity(), View.OnClickListener {
    ...
    fun startCountDown(){
        val count=findViewById<TextView>(R.id.count_down)
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            Toast.makeText(this@QuizActivity, "You have successfully completed the quiz. Your Score is : $mCorrectAnswers", Toast.LENGTH_SHORT).show()
                        }
                    }
                } else {
